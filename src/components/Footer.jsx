            ...
            <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-600">
                ...
                <div className="flex flex-col justify-center pt-6 lg:pt-0">
                    <div className="flex justify-center space-x-4">
                        <a rel="noopener noreferrer" href="#" title="Instagram" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-yellow-700 text-gray-50">
